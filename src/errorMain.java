...
public class errorMain {
    public static void main(String[] args) {
        String[] filenames = {
                "errorTests/syntaxError.grammarAmir",
                "errorTests/runTimeError.grammarAmir",
                "errorTests/logicalError.grammarAmir",
        };
        ...
        for (String filename : filenames) {
            ...
            try {
                ...
                System.err.println("Runtime error in file " + filename + ": " + e.getMessage());
            }
        }
    }
