...
public class grammarAmirLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "ID", "SELF_ID", 
			"INT", "STRING", "OPERATOR", "COMP_OP", "NEWLINE", "WS"
		};
	}
	...
	public grammarAmirLexer(CharStream input) {
		super(input);
